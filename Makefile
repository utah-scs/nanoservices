...
shredder : main.o connection_handler.o net_server.o req_server.o db.o scheduler.o
	$(CC) $(CFLAGS) -Lv8/x64.release/obj/ -o $@ -Wl,--start-group $^ -lv8_monolith -Wl,--end-group -ldl -lrt -pthread
